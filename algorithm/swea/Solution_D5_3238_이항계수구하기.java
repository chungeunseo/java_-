...
public class Solution_D5_3238_이항계수구하기 {    
	...
	// 각 테스트 케이스마다 첫 번째 줄에 세 자연수
	// n, r, p (0 ≤ r ≤ n ≤ 10^18, 2 ≤ p ≤ 10^5, p는 소수)가 공백으로 구분되어 주어진다.
    ...
    static long nCr(long n, long r, int p) { 
        ...
        if(n<p) {
        	...
        	// n<p 보다 크면 모듈러스 하면 작아진다. a=n%p
        	// 13C2 (mod 11)-> 78 (mod 11) =1 (mod 11)
        	// n>=p 면 p가 존재하기 때문에 나머지 0
        	// 13x12x11x10x9x8/(5x4x3x2) (mod 11)
        	// 13C5 (mod 11)-> 1235520/5! =10296(mod 11)=0
        	// 13C12 (mod 11) -> 2C1 (mod11)
        	long ret=1;
            while(n>0 || r>0){
                long a=n%p;
                long b=r%p;
